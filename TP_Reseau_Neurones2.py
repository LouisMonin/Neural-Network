#Dans ce fichier, nous expliquons les différentes étapes de création, 
#entrainement et test d'un RNA en Python. Les modules utilisés sont:
#sklearn pour la préparation des données et keras/tensorflow pour
#la manipulation du RNA proprement dite.
#L'ensemble de données utilisé dans ce guide est Iris.  L'objectif est de 
#prédire la classe Species.
